 ...
 */
final class Version20221017091729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE classroom DROP students, CHANGE name name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE classroom ADD students VARCHAR(100) NOT NULL, CHANGE name name VARCHAR(100) NOT NULL');
